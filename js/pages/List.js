...
export default {
                ...
                <div class="meta">
                    ...
                    <h3>Submission Requirements</h3>
                        ...
                        border-radius: 0.5rem; box-shadow: 0 1px 0.5rem 0 rgba(0, 0, 102, 0.5); transition: transform 100ms ease;">
                            {{ showEnglish ? 'Switch to Malay' : 'Tukar ke Bahasa Inggeris' }}
                        </button>
    ...
    data: () => ({
        ...
        submissionRules: {
            ...
            '2) Bagi yang menggunakan "FPS Bypass", had maksimum adalah 240fps/bps.',
        ...
        english: [
            '1) Same with the other lists, hacks that give players an unfair advantage are prohibited.',
            '2) For those using FPS Bypass, the maximum limit is 240fps/bps.',
            '3) Only Malaysians are allowed to submit their records here.',
            ...
            '6) "Skips" can be used as long as they do not significantly reduce difficulty. If the skipped part is the hardest, it is not allowed.',
